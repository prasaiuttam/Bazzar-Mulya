...
public  class  MyListFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState)
    {
        ...
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(getActivity(),R.layout.mytextfragment,R.id.txtitem,products);
       ...
       // myDB.insertData("Mayos", "Kathmandu", 25);
        Cursor cursor = myDB.getDataByProductName();
